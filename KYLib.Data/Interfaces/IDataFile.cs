...
namespace KYLib.Interfaces
{
    ...
    public interface IDataFile
    {
        ...
        /// </summary>
        /// <param name="path">Ubicación desde la que se cargara el archivo. El archivo debe contener la cadena
		/// <see cref="Extension"/> al final del la ruta pero no debe estar incluida en <paramref name="path"/>.</param>
        /// <returns>Un nuevo objeto con los datos deserializados.</returns>
